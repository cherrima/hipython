...
import type { InvestmentReport as InvestmentReportType } from "@/lib/types"

interface InvestmentReportProps {
  report: InvestmentReportType
}

export default function InvestmentReport({ report }: InvestmentReportProps) {
  return (
    <div className="p-6">
      <h2 className="text-xl font-bold text-foreground mb-6">투자보고서</h2>
